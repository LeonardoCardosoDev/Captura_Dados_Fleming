    ...
    .on("data", async (data) => {
      ...
      if (HABILITAR_OPERACAO_INSERIR) {
        if (AMBIENTE == "producao") {
          ...
          sqlquery = `INSERT INTO captura (fkSensor,fkSala, fkLaboratorio, fkCliente, umidadeA, umidadeB, umidadeC, umidadeD,umidadeE,dtTime) VALUES (1,1,100,1,${dht11Umidade}, ${dht11Temperatura}, ${luminosidade}, ${lm35Temperatura}, ${chave}, CURRENT_TIMESTAMP)`;

          // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
          // Importante! você deve ter criado o usuário abaixo com os comandos presentes no arquivo
          // "script-criacao-usuario-sqlserver.sql", presente neste diretório.
          const connStr =
            "Server=svr-projeto-fleming.database.windows.net;Database=fleming;User Id=usuarioParaAPIArduino_datawriter;Password=#Gf_senhaParaAPI;";
